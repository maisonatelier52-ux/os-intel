...
export const metadata = {
  ...
  description:
    "OS-Intel is an independent news and investigation platform covering world affairs, conflict, cybersecurity, geo-politics, and dark web intelligence. Learn about our mission and team.",
  alternates: { canonical: `${SITE_URL}/about` },
  openGraph: {
    title: `About Us — Independent News & Investigation | ${SITE_NAME}`,
    description:
      "OS-Intel is an independent news and investigation platform covering world affairs, conflict, cybersecurity, geo-politics, and dark web intelligence.",
    url: `${SITE_URL}/about`,
    siteName: SITE_NAME,
    type: "website",
  },
...
const PILLARS = [
  {
    ...
    title: "Independence",
    body:
      "OS-Intel accepts no funding from governments, political parties, or corporate advertisers with editorial influence. Our reporting answers only to the facts.",
  },
  {
    number: "02",
    title: "Verification",
    body:
      "Every story undergoes multi-source verification before publication. We do not publish rumour, conjecture, or unconfirmed intelligence — regardless of the pressure to be first.",
  },
  {
    number: "03",
    title: "Accountability",
    body:
      "We name our authors, cite our sources where possible, and issue corrections prominently. Transparency is not optional — it is the foundation of trust.",
  },
  {
    number: "04",
    title: "Depth",
    body:
      "Breaking news matters. Context matters more. OS-Intel combines speed with substance, giving readers the intelligence they need to understand — not just know — what is happening.",
  },
];
...
const COVERAGE = [
  ...
  { area: "Investigation", desc: "Long-form investigative journalism exposing corruption, cover-ups, and systemic failures." },
];
      ...
      <section className="w-full border-b border-gray-200">
        <div className="px-4 md:px-6 py-14 md:py-20 max-w-5xl">
          ...
          <h1 className="text-4xl md:text-6xl font-black font-playfair text-gray-900 leading-tight mb-6">
            Independent News.<br />
            <span className="text-red-600">Uncompromised</span> Intelligence.
          </h1>
          <p className="text-gray-600 text-base md:text-lg font-serif leading-relaxed max-w-2xl">
            OS-Intel was founded on a single premise: that the world deserves reporting which
            is rigorous, fearless, and free from the pressures that compromise so much of
            modern journalism. We cover the stories that matter — the ones that are difficult,
            dangerous, and deliberately ignored.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-0 md:divide-x md:divide-gray-700">
            {[
              ...
              <div key={item.label} className="md:px-8 first:pl-0 last:pr-0">
                <p className="text-3xl md:text-4xl font-black font-playfair text-red-500 mb-1">
                  {item.stat}
                </p>
          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-16">
            ...
            <div className="flex-1 flex flex-col gap-5 font-serif text-gray-600 text-sm leading-relaxed">
              <p>
                ...
                sources. We apply that rigour to every story we publish, whether it originates
                from a leaked document, a satellite image, a whistleblower, or a court filing.
              </p>
              <p>
                We believe that an informed public is the strongest defence against authoritarianism,
                corruption, and the manipulation of information. Every article we publish is written
                with that belief as its foundation.
              </p>
              <p>
                OS-Intel does not sensationalise. We do not traffic in outrage for clicks. We
                report what we can verify, explain what it means, and trust our readers to form
      ...
      <section className="w-full border-b border-gray-200">
        <div className="px-4 md:px-6 py-14 max-w-5xl">
          ...
          <h2 className="text-3xl font-black font-playfair text-gray-900 mb-10">
            The four pillars of OS-Intel journalism.
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {COVERAGE.map((c) => (
              <div key={c.area} className="border-l-2 border-red-600 pl-4">
                <h3 className="text-base font-black font-serif text-gray-900 mb-1">
                  {c.area}
                </h3>
          ...
          <div className="flex flex-col md:flex-row gap-6 md:items-center">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 font-serif leading-relaxed">
                ...
                error in our reporting, please contact our editorial team.
              </p>
            </div>
