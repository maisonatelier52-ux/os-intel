...
const SECTIONS = [
  {
    ...
    title: "1. Acceptance of Terms",
    content:
      `By accessing or using the OS-Intel website at os-intel-bice.vercel.app (the "Site"), you agree to be bound by these Terms and Conditions ("Terms"). If you do not agree to all the terms and conditions of this agreement, you may not access or use the Site. OS-Intel reserves the right to update or modify these Terms at any time without prior notice. Your continued use of the Site following any changes constitutes your acceptance of those changes. These Terms were last updated on ${LAST_UPDATED}.`,
  },
  {
    id: "use-of-site",
    title: "2. Use of the Site",
    content:
      "You agree to use OS-Intel solely for lawful purposes and in a manner that does not infringe the rights of others or restrict or inhibit anyone else's use of the Site. Prohibited behaviour includes, but is not limited to: transmitting unsolicited commercial email; posting defamatory, offensive, or fraudulent content; attempting to gain unauthorised access to our systems; scraping or harvesting content in an automated manner without our express written consent; and impersonating any person or entity.",
  },
  {
    id: "intellectual-property",
    title: "3. Intellectual Property",
      ...
      <section className="w-full border-t border-gray-200 bg-gray-900">
        <div className="px-4 md:px-6 py-10 max-w-4xl">
          ...
          <p className="text-white font-serif text-sm leading-relaxed max-w-2xl">
            ...
            <Link href="/privacy-policy" title="Privacy Policy" className="text-red-400 hover:text-red-300 transition-colors underline">
              Privacy Policy
            </Link>.
          </p>
        </div>
