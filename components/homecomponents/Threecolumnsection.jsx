...
export default function ThreeColumnSection({
  ...
  return (
    <section className="w-full px-4 md:px-6 py-10" aria-label="Featured and trending news">
      <div className="flex flex-col md:flex-row gap-6">

        {/* ════════ LEFT COLUMN — 25% ════════ */}
        <div className="w-full md:w-[25%] flex flex-col gap-6">

          {/* ✅ SEO: H2 section heading */}
          <div className="flex items-center justify-between pb-2">
            <h2 className="text-xl font-black font-serif tracking-wide border-b-2 border-red-600 pb-2 -mb-[9px]">
              Featured News
            </h2>
          ...
          <Link
            href={featuredNewsCard.href}
            title={`Read featured: ${featuredNewsCard.title}`}
            className="block relative group overflow-hidden"
          >
            <div className="relative w-full h-[180px] overflow-hidden bg-gray-200">
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-3">
                ...
                {/* ✅ SEO: H3 under H2 "Featured News" */}
                <h3 className="text-white text-sm font-black font-serif leading-snug group-hover:text-gray-200 transition-colors">
                  {featuredNewsCard.title.length > 60
                    ? `${featuredNewsCard.title.slice(0, 60)}...`
              ...
              {moreFromNewsMag.map((item, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {/* ✅ SEO: H3 under H2 "More from OS-Intel" */}
                    <h3 className="text-gray-900 text-xs font-bold font-serif leading-snug group-hover:text-red-600 transition-colors">
                      {item.title.length > 50 ? `${item.title.slice(0, 50)}...` : item.title}
                    </h3>
                  </div>
                </Link>
        ...
        <div className="w-full md:w-[50%] flex flex-col gap-0 md:px-6">
          {middleArticles.map((article, index) => (
            <div key={index} className={index > 0 ? "border-t border-gray-200 pt-6" : ""}>
              ...
              {/* ✅ SEO: H2 for middle column article titles (major content area) */}
              ...
              {/* ✅ SEO FIX: Descriptive link text with sr-only context */}
              <Link
                href={article.href}
        ...
        <div className="w-full md:w-[25%] flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-5">
            {rightTopArticles.map((article, i) => (
              ...
              >
                ...
                {/* ✅ SEO: H3 for right column cards (under right column context) */}
                <h3 className="text-gray-900 text-lg font-bold font-serif leading-snug group-hover:text-red-600 transition-colors">
                  {article.title.length > 70 ? `${article.title.slice(0, 70)}...` : article.title}
                </h3>
              </Link>
            ))}
          ...
          <Link
            href={rightVideoCard.href}
            title={`Read: ${rightVideoCard.title}`}
            className="block relative group overflow-hidden"
          >
            <div className="relative w-full h-[370px] overflow-hidden bg-gray-200">
              <Image
