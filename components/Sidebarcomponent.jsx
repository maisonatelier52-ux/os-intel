    ...
    <div className="flex flex-col gap-8">
        ...
        <div className="bg-gray-50 border border-gray-100">
          {latestNews.map((item, i) => (
            <div key={i}>
              ...
              >
                <p className="text-gray-400 text-[11px] font-sans tracking-wide mb-1">{item.date}</p>
                {/* ✅ HEADING ORDER FIX: h3 (not h4) — sits under H2 "The Latest News" */}
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-1 gap-2">
          ...
          {/* Facebook */}
          <Link href="#" title="Follow OS-Intel on Facebook" className="flex items-center bg-[#3b5998] hover:bg-[#344e86] transition-colors group">
            <div className="w-12 h-12 flex items-center justify-center shrink-0">
          ...
          {/* Twitter / X */}
          <Link href="#" title="Follow OS-Intel on Twitter" className="flex items-center bg-[#1da1f2] hover:bg-[#1a90d9] transition-colors group">
            <div className="w-12 h-12 flex items-center justify-center shrink-0">
              <svg viewBox="0 0 24 24" fill="white" className="w-5 h-5" aria-hidden="true">
                <path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z" />
              </svg>
          ...
          {/* Instagram */}
          <Link href="#" title="Follow OS-Intel on Instagram" className="flex items-center bg-[#00aadb] hover:bg-[#0099c5] transition-colors group">
            <div className="w-12 h-12 flex items-center justify-center shrink-0">
      ...
      <div>
        <div className="mb-4">
          {/* ✅ h2 for section heading — consistent with other sidebar sections */}
          <h2 className="text-xl font-black font-playfair tracking-wide inline-block border-b-2 border-red-600 pb-1">
            Most Popular
          </h2>
        </div>
          ...
          {mostPopular.map((item, i) => (
            <div key={i}>
              ...
              <Link
                href={item.href}
                title={`Read: ${item.title}`}
                aria-label={`Read popular article: ${item.title}`}
                className="flex items-start gap-3 px-4 py-7 group hover:bg-gray-50 transition-colors"
              >
                <span className="text-gray-300 text-3xl font-black font-playfair leading-none shrink-0 w-5 text-center" aria-hidden="true">
                  {i + 1}
                </span>
                <div className="flex-1 min-w-0">
                  {/* ✅ HEADING ORDER FIX: h3 (not h4) — under H2 "Most Popular" */}
