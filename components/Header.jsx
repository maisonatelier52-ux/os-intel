    ...
    <header className="w-full px-4">
      <div className="border-b border-gray-300 relative">
        ...
        <div className="flex items-center justify-between px-4 md:px-6 py-2 border-b border-gray-200 text-sm overflow-hidden">
          ...
          {/* Desktop: Date + Social Icons */}
          <div className="hidden md:flex items-center gap-5 shrink-0 ml-6">

            {/* Current date */}
            <span className="font-serif text-xs font-semibold text-gray-600 tracking-wide whitespace-nowrap select-none">
        ...
        {/* Mobile: top drawer — date + social */}
          <div
            className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out ${
              topMenuOpen ? "max-h-64 opacity-100" : "max-h-0 opacity-0"
            }`}
          >
            <div className="flex flex-col items-center py-4 gap-4 border-b border-gray-200 bg-white">

              {/* Date */}
              <span className="font-playfair text-xs font-semibold text-gray-600 tracking-wide text-center select-none">
                {new Date().toLocaleDateString("en-US", {
                  weekday: "long",
                  year: "numeric",
                  month: "long",
