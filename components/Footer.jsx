...
// // ✅ SEO FIX: h4 → h3 to fix heading order (footer sits after h2 sections)
// function ArticleCard({ article }) {
//   return (
//     <Link
//       href={`/${article.category}/${article.slug}`}
...
//             </Link>
//             <p className="text-gray-600 text-sm font-serif leading-relaxed">
//               OS-Intel delivers sharp, independent coverage across world affairs, conflict zones,
//               geo-politics, cybersecurity, dark web investigations, and more. We cut through the
//               noise to bring you news that matters — accurate, in-depth, and always timely.
//             </p>
//           </div>

//           {/* Column 2 — Featured (25%) */}
//           <div className="w-full md:w-[25%]">
//             {/* ✅ SEO: H2 for footer section headings */}
//             <h2 className="text-xl font-black font-serif text-gray-900 mb-6 pb-2 border-b-2 border-red-600 inline-block">
//               Featured
//             </h2>
//             <div className="flex flex-col gap-5">
